...
TEAM1_ACTOR_RATE:     float = 1e-4
TEAM1_CRITIC_RATE:    float = 1e-4
TEAM2_ACTOR_RATE:     float = 1e-4
TEAM2_CRITIC_RATE:    float = 1e-4
...
class HyperParameters():
    ...
    team1_actor_rate:     float = TEAM1_ACTOR_RATE          # team1 actor学习率
    team1_critic_rate:    float = TEAM1_CRITIC_RATE         # team1 critic学习率
    team2_actor_rate:     float = TEAM2_ACTOR_RATE          # team2 actor学习率
    team2_critic_rate:    float = TEAM2_CRITIC_RATE         # team2 critic学习率
